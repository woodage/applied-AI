...
theta1 = np.array([[random.uniform(0.2, 0.5), random.uniform(0.2, 0.5), random.uniform(0.2, 0.5), random.uniform(0.2, 0.5)],
                    [random.uniform(0.2, 0.5), random.uniform(0.2, 0.5), random.uniform(0.2, 0.5), random.uniform(0.2, 0.5)]
                   ])
...
theta3 = np.array([[random.uniform(0.2, 0.5), random.uniform(0.2, 0.5), random.uniform(0.2, 0.5)]])
...
print("result")
print(forward(np.array([[1, 1, 1]]), thetaList, relu, -1))
print(forward(np.array([[0, 1, 0]]), thetaList, relu, -1))
print(forward(np.array([[1, 0, 0]]), thetaList, relu, -1))
print(forward(np.array([[0, 0, 0 ]]), thetaList, relu, -1))
